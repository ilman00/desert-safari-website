...
export default function NewBlogPage() {
  ...
  return (
    <div className="container mt-5 mb-5 rounded col-md-8 pb-3" style={{backgroundColor: "#F2F2F2"}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          {coverImage && (
            <Image width={200} height={200} src={coverImage} alt="Cover Preview" className="img-fluid mt-2 rounded" />
          )}
        </div>
